...
public class CalculatorTest {
    ...
    void additionTest() {
        ...
        int result = Calculator.caculate(new PositiveNumber(1), "+", new PositiveNumber(2));
    ...
    void calculateTest(int operand1, String operator, int operand2, int result) {
        ...
        int caculateResult = Calculator.caculate(new PositiveNumber(operand1), operator, new PositiveNumber(operand2));
